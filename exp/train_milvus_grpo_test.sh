...
WAND_PROJECT='test-search-r1'
# export WANDB_API_KEY='local-8691205abe5aa0fb7c393939669aec50167070c7'
export BASE_MODEL='/rt-vepfs/public_model/Qwen/Qwen2.5-1.5B'
export EXPERIMENT_NAME=search-r1-grpo-qwen2.5-1.5b-em-a800-test
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.default_local_dir=/rt-vepfs/xjl/Search-R1/outputs/verl_checkpoints/$EXPERIMENT_NAME \
