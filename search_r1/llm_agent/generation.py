...
class LLMGenerationManager:
    ...
    def execute_predictions(
        ...
        if do_search:
            ...
            elif self.config.search_engine == "milvus":
                search_results = self.batch_milvus_search(search_queries)
            else:
                raise ValueError(f"Invalid search engine: {self.config.search_engine}")
